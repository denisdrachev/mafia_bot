...
sealed interface CallbackData {
    ...
    data class LobbyStart(val chatId: Long) : CallbackData
    ...
    companion object {
        ...
        private const val LOBBY_START = "ls"
        ...
        fun encode(data: CallbackData): String = when (data) {
            ...
            is LobbyStart -> "$LOBBY_START:${data.chatId}"
        ...
        fun decode(raw: String?): CallbackData? {
            ...
            return runCatching {
                when (parts[0]) {
                    ...
                    LOBBY_START -> LobbyStart(parts[1].toLong())
